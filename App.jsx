...
function App() {
  // We use these variables to store our data
  const [allTodos, setTodos] = useState([]); // List of all tasks
  const [newTitle, setNewTitle] = useState(''); // Title of the new task
  const [newDescription, setNewDescription] = useState(''); // Description of the new task
  const [completedTodos, setCompletedTodos] = useState([]); // List of completed tasks
  const [isCompleteScreen, setIsCompleteScreen] = useState(false); // To show either tasks or completed tasks
  const [currentEdit, setCurrentEdit] = useState(null); // Index of the task being edited
  const [currentEditedItem, setCurrentEditedItem] = useState({}); // Task being edited
